...
// 언터셉터로 사용할 클래스는 HandlerTintercetop 인터페이스를 구현합니다
@Slf4j
public class UserLoginSuccessHandler implements HandlerInterceptor{
	...
	if(request.getMethod().equals("POST")) {
		...
		UserVO vo = (UserVO) map.get("user"); // 도멜 내에 user라은 이름의 데이터 꺼내기
//		log.info("언터셉터 내부에서 user 확인: " + vo.toString());
