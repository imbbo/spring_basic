        ...
        <div class="row">
            <div class="col-lg-6 col-md-9 col-sm-12 join-form">
                ...
                <form action="${pageContext.request.contextPath}/user/join" method="post" name="joinForm">
                    ...
                    <div class="form-group">
                        <input type="text" name="addrBasic" class="form-control" id="addrDetail" placeholder="상세주소">
                    </div>
    ...
    <script>
        ...
        document.querySelector('.mail-check-input').onblur = function(e) {
            ...
            if(inputCode === code) {
                ...
                // 초기값은 사용자가 선택한 값으로 무조건 설정하는 방법(select에서 readonly 대용)
                // 항상 2개 같이 쓰셔야 합니다.
