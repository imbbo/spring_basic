...
<%@ include file="../include/footer.jsp" %>
    ...
    document.getElementById('idCheckBtn').onclick = function() {
        ...
        */
        ...
        소비할 수 있게 해줍니다.(promise: 비동기 통신의 순서르 보장하는 문법)
        - fetch함수가 리턴하는 promise 객체는 다눈한 응답 JSON 데이턱 ㅏ아닌
        ...
        */
        ...
        document.getElementById('mail-check-btn').onclick = function() {
            const email = document.getElementById('userEmail').value + document.getElementById('userEmail2').value;
