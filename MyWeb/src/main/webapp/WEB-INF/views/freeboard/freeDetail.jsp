					...
					<div class='reply-wrap'>
						...
						<div class='reply-content'>
							<div class='reply-group'>
								...
								<a href='#' class='right'><span class='glyphicon glyphicon-pencil'></span>수정</a> <a
									href='#' class='right'><span class='glyphicon glyphicon-remove'></span>삭제</a>
							</div>
...
<script>
	...
	window.onload = function() {
		...
		// 댓글 목록을 가져올 함수.,
		// getList의 매개값으로 뭘 줄거잇인가
		// 요청된 페이지 번호와, 화면을 리셋할 것인지의 여부를 bool 타입의 reset으로 받겠습니다.
		// (페이지가 그대로 머물면서 댓글이 계속 쌓이기 떄문에, 상황에 따라서
		// 페이지를 리셋해서 새롭게 그려낼 것인지, 누적해서 쌓을것인지의 여부를 판단)
