package com.spring.myweb.freeboard.mapper.controller;
...
public class FreeBoardControllerTest {
	...
	/*
	 - 테스트 환경에서 가상의 DispathvherServlet을 사용하기 위한 객체 자동 주입
...
//	private FreeBoardController controller;
	...
	public void setup() {
		...
		// 테스트할 컨트롤러를 수동으로 주입. 하나의 컨트롤러 자체만 테스르르 진행할 때 이렇게 씀
//		this.mockMvc = MockMvcBuilders.standaloneSetup(controller).build(); 위 controller 포함
	}
